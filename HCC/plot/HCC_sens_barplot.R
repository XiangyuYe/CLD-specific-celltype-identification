...
###plot out
pdf(paste0("/home/integ_project/rolypoly/single_cell_data/integrated_HCC/estimates_HCC2.pdf"),
    height = 9,width = 16)
p1+p2+p3
dev.off()

tiff(paste0("/home/integ_project/rolypoly/single_cell_data/integrated_HCC/estimates_HCC2.tiff"),
